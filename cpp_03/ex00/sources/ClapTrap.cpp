...
/*   Updated: 2024/12/02 16:13:48 by yadereve         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default constructor called fot " << _name << std::endl;
}
...
void ClapTrap::attack(const std::string &target)
{
	if (_hitPoints > 0 && _energyPoints > 0)
	{
		...
		std::cout << _name << " cannot repair itself. Not enough energy or health!" << std::endl;
}
